---
name: support-new-platform
description: Use when adding support for a new social platform through isolated extraction logic and shared normalized card generation.
---
